...
if __name__ =="__main__" :
    ...
    t0 = time.time()
    model,kernel= launch_analysis(X,Y,X_s,straigth=True,do_plot=False,depth=2,verbose=True,initialisation_restart=10,reduce_data=False,experimental_multiprocessing=True) #straight parameters == True
